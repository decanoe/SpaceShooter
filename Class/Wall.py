...
class Wall(Collider, runner.Object):
    ...
    def __init__(self, screen : pygame.Surface, game_objects: list[runner.Object], pos: Vector, size : Vector, invert: bool = False) -> None:
    ...
    def update(self):
        ...
        rect: pygame.Rect = self.sprite.get_rect(center = self.GAME_OBJECTS[0].centerOnPos(self.pos).toTuple())
